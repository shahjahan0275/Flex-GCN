...
class opts():
    ...
    def init(self):
        ...
        self.parser.add_argument('-norm', '--norm', default=.03, type=float, metavar='N', help='constraint  of sparsity')
        ...
        self.parser.add_argument('--flex_gcn_reload', type=int, default=0, help='if continue from last time')
        ...
        self.parser.add_argument('--module_flex_model', type=str, default='', help='model name')
        ...
        self.parser.add_argument('-previous_flex_gcn_name', type=str, default='', help='save last saved model name')
